...
func getRecipes() -> [Recipe]{
    ...
    recipes = [Recipe(tituloReceita: "Pão de Queijo",
               ...
               Recipe(tituloReceita: "Brigadeiro",
                      ...
                      descricaoReceita: ["Em uma panela coloque todos os ingredientes, menos o granulado.","Misture até ficar homogêneo.","Leve ao fogo baixo, sem para de mexer, por aproximadamente 10 minutos, até engrossar.","Coloque num prato e deixe esfriar na geladeira por 30 minutos após disso retire.","Faça pequenas bolinhas e adicione chocolate granulado. ","Sirva e aproveite!"], numeroEtapas: 3,
                      imagemIntrucao:
